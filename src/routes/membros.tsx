      ...
      <main className="max-w-6xl mx-auto px-4 py-10 space-y-12">
        ...
        <section id="outros-produtos" className="space-y-6 pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Produto 0: Software de Prospecção B2B Google Maps (Upsell) */}
            <div className="bg-gradient-to-b from-[#181928] to-[#111218] border border-primary/40 rounded-2xl p-6 flex flex-col justify-between hover:border-primary/70 transition-all space-y-4 group relative overflow-hidden">
              <div className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground leading-relaxed">
                  Rastreie empresas sem site no Google Maps, construa a demonstração oficial ao vivo em 1-clique e feche contratos. Requer licença de acesso própria (R$ 97/mês ou R$ 497/ano).
                </p>

                <div className="p-3 bg-black/40 rounded-xl border border-white/10 text-[11px] space-y-1">
                  <p className="text-white font-semibold">✨ Destaques da Ferramenta:</p>
                  <p className="text-muted-foreground text-[10px]">• Filtro sem Website no topo</p>
                  <p className="text-muted-foreground text-[10px]">• Gerador de Site ao Vivo</p>
                  <p className="text-muted-foreground text-[10px]">• Scripts de Abordagem WhatsApp</p>
                </div>
              </div>
              ...
              >
                <Lock size={14} />
                <span>Adquirir Acesso (R$ 497/ano)</span>
                <ChevronRight size={14} />
              </a>
            </div>
